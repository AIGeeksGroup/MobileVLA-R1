...
def prepare_config_for_training(
    ...
    config.use_depth_tower = getattr(model_args, "use_depth_tower", False)
    config.use_point_tower = getattr(model_args, "use_point_tower", False)
    config.depth_tower_cfg = getattr(model_args, "depth_tower", None)
    config.point_tower_cfg = getattr(model_args, "point_tower", None)
    config.depth_hidden_size = getattr(model_args, "depth_hidden_size", None)
    config.point_hidden_size = getattr(model_args, "point_hidden_size", None)
    config.pointcloud_points = getattr(model_args, "pointcloud_points", None)
    # set default dtype
